...
release:          ## Create a new tag for release.
	...
	@echo "$${TAG}" > beer_game/VERSION
	@$(ENV_PREFIX)gitchangelog > HISTORY.md
	@git add beer_game/VERSION HISTORY.md
...
switch-to-poetry: ## Switch to poetry package manager.
	...
	@echo "beer_game = 'beer_game.__main__:main'" >> pyproject.toml
	...
	@echo "Please run 'poetry shell' or 'poetry run beer_game'"
